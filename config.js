...
module.exports = {
     ...
     */
    botname: process.env.BotName || "OKARUN MD",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 CYBER TECH ☢️",
     ...
     */
    ownername: process.env.Owner_Name || "CYBER TECH ☢️",
    ownernumber: process.env.Owner_Number || "2250565647864",
    instagramId: process.env.Insta || "",

    /**
     * other details and parameters
     */
    author: process.env.Author || "CYBER TECH ☢️",
    packname: process.env.PackName || "CYBER TECH ☢️ sticker pack",
    socialLink: process.env.Web || "https://github.com/MissAri1",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/LCI0lWtfgOHE2lOyaBMxwE",
    ...
    imageUrl: "https://walpapercave.com/uwp4572692.jpeg", // image url, to replace to your url upload your image to https://imgbb.com
    imageMentionUrl: "https://walpapercave.com/uwp4572692.jpeg", // image for mention reply audio media
